...
import { DataTableColumn, UseDataTable } from './dataTableTypes';
...
export const useDataCellHelpers = (storageHelpers: UseLocalStorageHelpers) => (column: DataTableColumn) => {
